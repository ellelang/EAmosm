...
data_folder = Path("C:/Users/langzx/Desktop/deapexample/deap-master/examples/ga/pareto_front")
...
if __name__ == "__main__":
    # with open("data_folder/zdt1_front.json") as optimal_front_data:
    #     optimal_front = json.load(optimal_front_data)
