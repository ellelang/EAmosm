"""
Created on Mon Mar 22 10:59:31 2021

@author: ellelang
"""
from pathlib import Path
data_folder =  Path('/Users/ellelang/Desktop/github/EAmosm/data/MRB2020')
...
dat1aat = pd.read_csv (data_folder/"1AAT0403.csv")
...
df_dataset.head()
df_dataset.to_csv(data_folder/'lambda_1aat0403.csv', index = False)
...
df_dataset.head()
df_dataset.to_csv(data_folder/'withinrank_1aat0403.csv', index = False)
...
with pd.ExcelWriter(data_folder/'seeds_acrossgenome.xlsx') as writer:
    for i in range(len(ldname)):
        report = seeds_df[i]
