...
g0 = sns.catplot(x="Type", y="Distribution", hue="CostLevel", data=datald_1,
               height=5, kind="bar", palette = "Blues")
g0.set(ylim=(0, 1))
g0.set_ylabels("Distribution of Selected MOs")
g0.set_xlabels("")
g0.set_titles('$\lambda = 1$')
g0.fig.text(0.35, 0.8,'$\lambda = 1$', fontsize=16) 
...
g1.set_ylabels(' ')  
g1.set_xlabels("")
g1.fig.text(0.35, 0.8,'$\lambda = 0.5$', fontsize=16) #add text



g2 = sns.catplot(x="Type", y="Distribution", hue="CostLevel", data=datald_0,
                height=5, kind="bar", palette = "Blues",legend_out=False)
g2.set_titles('$\lambda = 0$')
g2.set(ylim=(0, 1))
g2.set_ylabels(' ')  
g2.set_xlabels("")
g2.fig.text(0.35, 0.8,'$\lambda = 0$', fontsize=16) 
...
plt.show()
fig.savefig('distributionplot.pdf',dpi = 500)   
